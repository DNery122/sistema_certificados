...
function guardar_editar(e) {
  ...
  $.ajax({
    url: "../../controller/instructorController.php?op=guardar_editar",
    type: "POST",
    data: formData,
    contentType: false,
    processData: false,
...
$(document).ready(function () {
  $("#instructor_data").DataTable({
    ...
    ajax: {
      url: "../../controller/instructorController.php?op=listar",
      type: "post",
    },
    bDestroy: true,
    responsive: true,
  ...
  $("#sexo").select2({
    dropdownParent: $("#modal_instructor"),
  });
});
...
function editar(id) {
  $.post(
    "../../controller/instructorController.php?op=mostrar",
    { id: id },
    function (data) {
...
function eliminar(id) {
  Swal.fire({
    ...
    if (result.value) {
      $.post(
        "../../controller/instructorController.php?op=eliminar",
        { id: id },
        function (data) {
          $("#instructor_data").DataTable().ajax.reload();
